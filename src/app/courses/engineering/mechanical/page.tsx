...
export default function MechanicalPage() {
    ...
    const mechanicalProducts = allProducts.filter(p => p.category === "Mechanical");
                ...
                <div className="container max-w-7xl">
                    <div className="text-center mb-12">
                        ...
                        <p className="mt-2 text-muted-foreground md:text-xl">
                           Explore core subjects of Mechanical Engineering.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                     ...
                     {mechanicalProducts.length === 0 && (
                        <div className="text-center py-16 text-muted-foreground">
                            <p>No products found for Mechanical Engineering.</p>
                        </div>
                    )}
                </div>
            </main>
